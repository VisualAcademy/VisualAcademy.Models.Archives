...
namespace VisualAcademy.Models.Archives
{
    ...
    public class ArchiveRepository : IArchiveRepository, IDisposable
    {
        ...
        public async Task<ArticleSet<Archive, int>> GetAllAsync<TParentIdentifier>(int pageIndex, int pageSize, string searchField, string searchQuery, string sortOrder, TParentIdentifier parentIdentifier)
        {
            var items =
                _context.Archives
                    .AsQueryable();
        ...
        public async Task<ArticleSet<Archive, int>> GetAllAsync<TParentIdentifier>(int pageIndex, int pageSize, string searchField, string searchQuery, string sortOrder, TParentIdentifier parentIdentifier, DateTime from, DateTime to)
        {
            var items =
                _context.Archives
                    .AsQueryable();
